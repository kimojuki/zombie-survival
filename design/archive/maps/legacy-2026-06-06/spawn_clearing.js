...
(function () {
  ...
  function buildCampLayout(scene, cx, cz, baseY, B) {
    ...
    _buildMarkerPole(root, 1.7, 0, 0.9, 1);

    // ── Ouest : zone nuit ───────────────────────────────────────────────────
    _buildBedroll(root, -2.05, 0, -0.15, 0.35);
    _buildBackpack(root, -1.55, 0, 0.55, 0.6);
    _buildLeanToShelter(root, -1.95, 0.02, 0.05, 0.18);
    _buildMarkerPole(root, -2.75, 0, 0.25, -1);

    // ── Nord (derrière le feu) : assises ─────────────────────────────────────
    _buildStumpSeat(root, -0.85, 0, 1.55, 0.20, 0);
    _buildStumpSeat(root, 0.85, 0, 1.55, 0.20, 0);
    _buildMarkerPole(root, -0.25, 0, 2.35, -1);
    _buildMarkerPole(root, 0.35, 0, 2.35, 1);
