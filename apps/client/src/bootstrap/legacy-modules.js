...
export const LEGACY_MODULES = [
  ...
  '/js/proc_roads.js',
  '/js/sector_02_town.js',
  '/js/beach_textures.js',
  '/js/beach_decor.js',
  '/js/beach_ambient_life.js',
  ...
  '/js/fps_arm_tuner.js',
  '/js/admin-go-here.js',
  '/js/admin-tp-bookmarks.js',
  '/js/admin-world-map.js',
  '/js/admin-world-map-overlay.js',
  '/js/admin-decor-undo.js',
  '/js/admin-decor-history.js',
  '/js/admin-server-flags.js',
  '/js/admin-server-announce.js',
  '/js/admin-map-presets.js',
  '/js/admin-fly.js',
  '/js/admin-zone-overlay.js',
  '/js/admin-world-time.js',
